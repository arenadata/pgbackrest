...
testRun(void)
{
    ...
    if (testBegin("manifestNewBuild()"))
    {
        ...
        TEST_ASSIGN(
            manifest,
            manifestNewBuild(storagePg, PG_VERSION_83, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_83), false, false, exclusionList, NULL),
            "build manifest");
        ...
        TEST_ASSIGN(
            manifest, manifestNewBuild(storagePg, PG_VERSION_84, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_84), true, false, NULL, NULL),
            "build manifest");
        ...
        TEST_ERROR(
            manifestNewBuild(storagePg, PG_VERSION_90, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_90), false, false, NULL, tablespaceList),
            AssertError,
        ...
        TEST_ASSIGN(
            manifest, manifestNewBuild(storagePg, PG_VERSION_91, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_91), true, false, NULL, NULL),
            "build manifest");
        ...
        TEST_ASSIGN(
            manifest, manifestNewBuild(storagePg, PG_VERSION_92, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_92), false, false, NULL, NULL),
            "build manifest");
        ...
        TEST_ASSIGN(
            manifest, manifestNewBuild(storagePg, PG_VERSION_94, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_94), false, true, NULL, NULL),
            "build manifest");
        ...
        TEST_ERROR_FMT(
            manifestNewBuild(storagePg, PG_VERSION_12, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_12), false, false, NULL, NULL),
            FileOpenError,
        ...
        TEST_ASSIGN(
            manifest, manifestNewBuild(storagePg, PG_VERSION_12, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_12), true, false, NULL, NULL),
            "build manifest");
        ...
        // pg_wal not ignored
        TEST_ASSIGN(
            manifest, manifestNewBuild(storagePg, PG_VERSION_13, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_13), false, false, NULL, NULL),
            "build manifest");
        ...
        TEST_ERROR(
            manifestNewBuild(storagePg, PG_VERSION_94, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_94), false, false, NULL, NULL),
        ...
        TEST_ERROR(
            manifestNewBuild(storagePg, PG_VERSION_94, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_94), false, true, NULL, NULL), FileOpenError,
    ...
    if (testBegin("manifestBuildIncr()"))
    {
        ...
        manifest->pub.data.pgCatalogVersion = pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_96);
