    ...
    if (testBegin("infoPgNew(), infoPgNewInternal(), infoPgSet()"))
    {
        ...
        TEST_ASSIGN(
            ...
            infoPgSet(
                ...
                pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_94)),
        ...
        TEST_ASSIGN(
            infoPg, infoPgSet(infoPg, infoPgArchive, PG_VERSION_95, 6569239123849665999, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_95)),
