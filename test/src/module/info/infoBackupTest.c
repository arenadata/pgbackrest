...
testRun(void)
{
    ...
    if (testBegin("InfoBackup"))
    {
        ...
        TEST_ASSIGN(
            infoBackup, infoBackupNew(PG_VERSION_94, 6569239123849665679, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_94), NULL),
        ...
        TEST_ASSIGN(
            infoBackup,
            infoBackupNew(
                PG_VERSION_10, 6569239123849665999, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_10),
        ...
        TEST_RESULT_VOID(
            infoBackupPgSet(infoBackup, PG_VERSION_94, 6569239123849665679, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_94)),
            "add another infoPg");
        ...
        TEST_ASSIGN(
            infoBackup, infoBackupPgSet(infoBackup, PG_VERSION_11, 6739907367085689196, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_11)),
            "upgrade db");
        TEST_RESULT_VOID(
    ...
    if (testBegin("infoBackupLoadFile() and infoBackupSaveFile()"))
    {
        ...
        InfoBackup *infoBackup = infoBackupNew(PG_VERSION_10, 6569239123849665999, pgCatalogTestVersion(dbmsPostgreSQL, PG_VERSION_10), NULL);
        TEST_RESULT_VOID(
