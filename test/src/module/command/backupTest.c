...
testRun(void)
{
    ...
    if (testBegin("backupFile()"))
    {
        ...
        TEST_ASSIGN(
            result,
            *(BackupFileResult *)lstGet(
                backupFile(repoFile, compressTypeNone, 1, false, cipherTypeAes256Cbc, STRDEF(TEST_CIPHER_PASS),
                    POSTGRESQL_PAGE_SIZE, fileList), 0),
        ...
        TEST_ASSIGN(
            result,
            *(BackupFileResult *)lstGet(
                backupFile(repoFile, compressTypeNone, 1, true, cipherTypeAes256Cbc, STRDEF(TEST_CIPHER_PASS), POSTGRESQL_PAGE_SIZE,
                    fileList), 0),
        ...
        TEST_ASSIGN(
            result,
            *(BackupFileResult *)lstGet(
                backupFile(repoFile, compressTypeNone, 0, false, cipherTypeAes256Cbc, STRDEF(TEST_CIPHER_PASS),
                    POSTGRESQL_PAGE_SIZE, fileList), 0),
