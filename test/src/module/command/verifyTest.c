...
testRun(void)
{
    ...
    if (testBegin("verifySetBackupCheckArchive(), verifyLogInvalidResult(), verifyRender()"))
    {
        ...
        TEST_RESULT_STR_Z(
            verifyRender(archiveIdResultList, backupResultList, cfgOptionBool(cfgOptVerbose), NULL, errorList),
            "\n"
...
#define EXPECTED_OUTPUT_JSON "{"\
        "\"errors\":["\
          ...
          "},{"\
            "\"level\":0,\"message\":\"No usable archive.info file\""\
          "}"\
        "],"\
        "\"stanza\":\"db\","\
        "\"status\":\"error\""\
...
#define EXPECTED_OUTPUT_JSON "{"\
  "\"errors\":["\
    ...
    "},{"\
      "\"level\":0,\"message\":\"backup info file and archive info file do not match\\narchive: id = 1, version = 9.5, system-id = 10000000000000090500\\nbackup : id = 2, version = 11, system-id = 10000000000000110000\\nHINT: this may be a symptom of repository corruption!\""\
    "}"\
  "],"\
  "\"stanza\":\"db\","\
  "\"status\":\"error\""\
...
#define EXPECTED_OUTPUT_JSON "{"\
  "\"errors\":["\
    "{"\
      "\"level\":5,"\
      "\"message\":\"unable to open missing file '/home/denis/arena/pgbackrest/test/test-0/repo/backup/db/backup.info' for read\""\
    "},"\
    "{"\
      "\"level\":5,"\
      "\"message\":\"unable to open missing file '/home/denis/arena/pgbackrest/test/test-0/repo/backup/db/backup.info.copy' for read\""\
    "},"\
    "{"\
      "\"level\":0,"\
      "\"message\":\"No usable backup.info file\""\
        ...
        TEST_RESULT_STR_Z(
            verifyProcess(cfgOptionBool(cfgOptVerbose)),
                ...
                "\"errors\":["\
                    ...
                    "{"\
                    "\"level\":5,"\
                    "\"message\":\"unable to open missing file '/home/denis/arena/pgbackrest/test/test-0/repo/backup/db/20181119-152800F/backup.manifest' for read\""\
                    "},"\
                    "{"\
                    "\"level\":4,"\
