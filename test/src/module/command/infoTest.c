    ...
    if (testBegin("infoRender()"))
    {
                ...
                "{"
                    ...
                    "\"backup\":["
                        "{"
                            ...
                            "\"link\":["
                                "{"
                                    "\"destination\":\"../pg_config/pg_hba.conf\","
                                    "\"name\":\"pg_hba.conf\""
                                "},"
                                "{"
                                    "\"destination\":\"../pg_stat\","
                            ...
                            "\"tablespace\":["
                                "{"
                                    "\"destination\":\"/tblspc/ts1\","
                                    "\"name\":\"ts1\","
                                    "\"oid\":1"
                                "},"
                                "{"
                                    "\"destination\":\"/tblspc/ts12\","
                                    "\"name\":\"ts12\","
                                    "\"oid\":12"
                                "}"
                            "],"
        ...
        TEST_RESULT_STR_Z(
            ...
            "["
                ...
                "}"
            "]",
            "json - backup set requested, no lsn start/stop location");
        ...
        TEST_RESULT_STR_Z(
            ...
            "["
                "{"
                    ...
                    "\"repo\":["
                        "{"
                            ...
                            "\"status\":{"
                                "\"code\":99,"
                                "\"message\":\"[CryptoError] unable to load info file '" TEST_PATH
                                    "/repo/backup/stanza3/backup.info' or '" TEST_PATH "/repo/backup/stanza3/backup.info.copy':\\n"
                                    "CryptoError: cipher header invalid\\n"
                                    "HINT: is or was the repo encrypted?\\n"
                                    "FileMissingError: unable to open missing file '" TEST_PATH
                                        "/repo/backup/stanza3/backup.info.copy' for read\\n"
                                    "HINT: backup.info cannot be opened and is required to perform a backup.\\n"
                                    "HINT: has a stanza-create been performed?\\n"
                                    "HINT: use option --stanza if encryption settings are different for the stanza than the global"
                                        " settings.\""
                ...
                "}"
            "]",
            "json - backup label not found, one repo in error");
